...
const GEMINI_API_KEY_1 = import.meta.env.VITE_GEMINI_API_KEY || process.env.API_KEY;
const GEMINI_API_KEY_2 = import.meta.env.VITE_GEMINI_API_KEY_2 || "AIzaSyA_hj5gYZmuf7hFOg9EPwNKdzqdsp8qv48";
